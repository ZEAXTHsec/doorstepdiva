                ...
                <tr key={m.name} className={`border-t border-blush/10 hover:bg-petal/30 transition-colors ${i % 2 === 0 ? 'bg-white' : 'bg-cream/30'}`}>
                  ...
                  <td className="px-6 py-4 text-right">
                    ...
                    <div className="mt-1.5 flex justify-end">
                      <AddToCartButton variant="inline" id={m.name} name={m.name} price={m.price} duration={m.time || ''} image="https://res.cloudinary.com/dzh0mxzbg/image/upload/v1777175128/Hair_service_cover_dxozc1.png" category="Semi-Permanent" href="/book" />
                    </div>
                  </td>
                </tr>
              ))}
            ...
            <div key={a.name} className={`reveal reveal-d${Math.min(i + 1, 2)} card-lift bg-white rounded-2xl p-5 border border-blush/20 flex items-center justify-between`}>
              ...
              <div>
                ...
                <div className="mt-1.5">
                  <AddToCartButton variant="inline" id={a.name} name={a.name} price={a.price} duration={a.time || ''} image="https://res.cloudinary.com/dzh0mxzbg/image/upload/v1777175128/Hair_service_cover_dxozc1.png" category="Semi-Permanent" href="/book" />
                </div>
              </div>
            </div>
          ))}
