...
const BREADCRUMB = [
  ...
  { label: 'Korean Glow Facial' },
]

const STEPS = [
  { title: 'Oil Cleanse + Foam Wash', desc: 'Gentle makeup-melting oil cleanser followed by a vitamin C-enriched foam wash to prep skin for maximum absorption.' },
  { title: 'Fruit Enzyme Exfoliation', desc: 'Papaya and pineapple enzyme gel dissolves dead skin cells without abrasion — revealing smoother, more receptive skin beneath.' },
  { title: 'Vitamin C Serum Infusion', desc: 'High-potency 20% vitamin C (L-ascorbic acid) serum applied in a patting motion to brighten, protect, and stimulate collagen synthesis.' },
  { title: 'Triple Hyaluronic Acid Mask', desc: 'Multi-weight HA molecules (low, medium, high) penetrate different skin layers simultaneously — surface hydration meets deep dermal moisture.' },
  { title: 'Ice Globe Depuffing Massage', desc: 'Cooling ice globes rolled across the face to constrict capillaries, reduce puffiness, tighten pores, and lock serum into the skin.' },
  { title: 'Dewy Finish SPF Seal', desc: 'Lightweight SPF 50+ gel-cream locks in all actives while giving the skin a dewy, camera-ready finish without white cast.' },
]

const RATING_BREAKDOWN = [
  { stars: 5, count: 49000, bar: 95 },
  { stars: 4, count: 1500, bar: 3 },
  { stars: 3, count: 400, bar: 0.8 },
  { stars: 2, count: 100, bar: 0.5 },
  { stars: 1, count: 150, bar: 0.7 },
]
...
const REVIEWS = [
  {
    name: 'Tanya Gupta',
    date: 'May 6, 2026',
    services: 'Korean Glow Facial, Threading: Eyebrow',
    rating: 5,
    text: 'The ice globe massage at the end was next level! My face looked so sculpted and dewy. Booked this before a wedding and got so many compliments on my skin.',
  },
  {
    name: 'Riya Malhotra',
    date: 'May 5, 2026',
    services: 'Korean Glow Facial, Bleach: Face & neck',
    rating: 5,
    text: 'Instantly glowing! The triple HA mask feels incredible and my skin was literally reflecting light afterwards. Perfect pre-event facial.',
  },
  {
    name: 'Shreya Patel',
    date: 'May 4, 2026',
    services: 'Korean Glow Facial, Full arms (RICA roll-on)',
    rating: 5,
    text: '60 minutes of pure bliss. The fruit enzyme step was so gentle — no tingling at all. My dry patches are completely gone and my skin feels plump and bouncy.',
  },
  {
    name: 'Neha Verma',
    date: 'May 3, 2026',
    ...
    rating: 5,
    text: 'Best facial for dehydrated skin! My fine lines around the eyes are visibly softer and the glow lasted through the weekend. Already rebooked.',
  },
  {
    name: 'Divya Joshi',
    date: 'May 2, 2026',
    services: 'Korean Glow Facial, Threading: Upper lip, Waxing: Chin',
    rating: 4,
    text: 'Great experience overall. The HA mask was the highlight — so plumping. Would love if they offered a longer massage portion, but otherwise excellent.',
  },
  {
    name: 'Pooja Chaudhary',
    date: 'May 1, 2026',
    services: 'Korean Glow Facial, Elysian British Rose manicure',
    rating: 5,
    text: 'The beautician was so knowledgeable about the ingredients. She explained why each step mattered and the results were visible immediately. Glowing, hydrated, fresh skin!',
  },
]
...
export default function KoreanGlowFacialPage() {
  return (
    <div className="bg-petal min-h-screen">
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
            <div style={{ animation: 'fadeUp .8s ease both' }}>
              ...
              <div className="flex flex-wrap gap-3">
                <AddToCartButton
                  ...
                  href="/services/skin/korean-glow-facial"
                />
            ...
            <div className="hidden md:block" style={{ animation: 'fadeUp .9s ease .15s both' }}>
              <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-rose/15">
                <img src="https://res.cloudinary.com/dzh0mxzbg/image/upload/v1777175149/Skin_service_nrbzmt.png" alt="Korean Glow Facial" className="w-full h-auto object-cover" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent" />
                <div className="absolute bottom-6 left-6 right-6 flex items-center gap-3">
                  <span className="font-poppins text-xs font-semibold text-white/90 bg-white/15 backdrop-blur-sm px-3 py-1.5 rounded-full border border-white/20">Vit C + HA</span>
                  <span className="font-poppins text-xs font-semibold text-white/90 bg-white/15 backdrop-blur-sm px-3 py-1.5 rounded-full border border-white/20">Ice Globe Massage</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-16 py-20">
        <div className="grid md:grid-cols-2 gap-12 items-start">
          <div className="reveal">
            <p className="font-poppins text-xs tracking-[0.3em] uppercase text-rose font-semibold mb-3">The Glow Formula</p>
            <h2 className="font-playfair text-3xl md:text-4xl font-bold text-stone mb-5 leading-tight">
              Instant dew,<br /><em className="text-rose">lasting hydration.</em>
            </h2>
            <p className="font-poppins text-sm text-stone-light leading-relaxed mb-4">
              Vitamin C (ascorbic acid) is one of the most studied skincare ingredients — it brightens, protects against free radicals, and stimulates collagen. But it needs hydration partners to work effectively without irritation.
            </p>
            <p className="font-poppins text-sm text-stone-light leading-relaxed mb-6">
              Our Korean Glow Facial combines high-potency 20% vitamin C with triple-weight hyaluronic acid — so you get the brightening punch without any dryness or tingling. The result: skin that looks lit from within in under 60 minutes.
            </p>
            <div className="flex flex-wrap gap-2">
              {['Vitamin C 20%', 'Triple HA', 'Papaya Enzymes', 'Ice Globes', 'SPF 50+'].map(ing => (
          ...
          <div className="reveal" style={{ animationDelay: '0.1s' }}>
            <div className="bg-white rounded-3xl p-8 border border-blush/20 shadow-lg shadow-rose/5">
              ...
              <div className="space-y-5">
                {[
                  { icon: '⏱', label: 'Duration', value: '1 hour' },
                  { icon: '💰', label: 'Price', value: '₹1,449 (all-inclusive)' },
                  { icon: '⭐', label: 'Rating', value: '4.81 from 51K reviews' },
                  { icon: '🎯', label: 'Best For', value: 'Dehydrated & dull skin' },
                  { icon: '💎', label: 'Result', value: 'Instant dewy glow' },
                  { icon: '🧴', label: 'Key Actives', value: 'Vit C 20% · Triple HA' },
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-16">
          <div className="text-center mb-14 reveal">
            ...
            <p className="font-poppins text-stone-light text-base max-w-lg mx-auto">
              Six rapid steps to take skin from tired to radiant — designed for instant results with zero downtime.
            </p>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          <div className="reveal text-center md:text-left">
            ...
            <h2 className="font-playfair text-4xl font-bold text-stone mb-8">
              Rated <em className="text-rose">4.81</em> by 51K clients
            </h2>
            <div className="flex items-center gap-3 mb-4 justify-center md:justify-start">
              <span className="font-playfair text-5xl font-bold text-stone">4.81</span>
              <div>
      ...
      <section className="px-6 md:px-16 pb-28">
        <div className="max-w-7xl mx-auto bg-stone rounded-[2.5rem] p-12 md:p-16 text-center relative overflow-hidden reveal">
          <div aria-hidden className="absolute -top-16 -left-16 w-64 h-64 rounded-full opacity-10" style={{ background: '#F0E8D8' }} />
          <p className="font-poppins text-xs tracking-[0.3em] uppercase text-rose-light font-semibold mb-4 relative z-10">Dewy Skin In 60 Minutes</p>
          <h2 className="font-playfair text-5xl font-bold text-white mb-6 relative z-10">
            Book Your Korean<br /><em className="text-blush">Glow Facial</em>
          </h2>
          <p className="font-poppins text-white/50 text-base max-w-lg mx-auto mb-4 relative z-10">Vitamin C 20% · Triple Hyaluronic Acid · Ice Globe Massage</p>
          <div className="flex items-center justify-center gap-4 mb-8 text-white/40 text-sm font-poppins relative z-10">
            <span>₹1,449</span><span>·</span><span>1 hr</span><span>·</span><span>4.81 ★</span>
          </div>
