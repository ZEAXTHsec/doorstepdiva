    ...
    <div className="bg-petal min-h-screen">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="hidden md:flex flex-col gap-4" style={{ animation: 'fadeUp .9s ease .15s both' }}>
              {[
                ...
                <div key={s.name} className="flex items-center gap-4 bg-white rounded-2xl p-5 border border-blush/20">
                  <div className="w-12 h-12 rounded-2xl flex-shrink-0" style={{ background: s.accent }} />
      ...
      <section className="bg-cream py-24">
        <div className="max-w-7xl mx-auto px-6 md:px-16">
          <div className="grid md:grid-cols-5 gap-10 items-start">
            <div className="md:col-span-2 rounded-3xl p-8 sticky top-28" style={{ background: '#F0D8E8' + '50' }}>
