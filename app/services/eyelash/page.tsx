            ...
            <div className="hidden md:block" style={{ animation: 'fadeUp .9s ease .15s both' }}>
              <div className="space-y-4">
                {EXTENSION_TYPES.map(e => (
                  <div key={e.name} className="bg-white rounded-2xl p-5 border border-blush/20 flex items-center gap-4">
                    <div className="w-12 h-12 rounded-2xl flex-shrink-0 flex items-center justify-center text-xs font-poppins font-bold text-rose"
