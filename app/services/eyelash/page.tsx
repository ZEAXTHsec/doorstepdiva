                  ...
                  <td className="px-6 py-4 text-right">
                    {e.price > 0 ? (
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <AddToCartButton variant="inline" id={e.name} name={e.name} price={e.price} duration={e.time || ''} image="https://res.cloudinary.com/dzh0mxzbg/image/upload/v1777175128/Hair_service_cover_dxozc1.png" category="Eyelash" href="/book" />
                      </div>
                    ) : <span className="font-poppins text-xs text-green-600 font-semibold">Free</span>}
                  </td>
                </tr>
              ))}
            </tbody>
            ...
            <div key={s.name} className={`reveal reveal-d${Math.min(i + 1, 3)} card-lift bg-white rounded-2xl p-6 border border-blush/20 flex flex-col ${i === 2 ? 'ring-1 ring-rose/20' : ''}`}>
              ...
              <div className="pt-4 mt-4 border-t border-blush/10 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <AddToCartButton variant="inline" id={s.name} name={s.name} price={s.price} duration={s.time || ''} image="https://res.cloudinary.com/dzh0mxzbg/image/upload/v1777175128/Hair_service_cover_dxozc1.png" category="Eyelash" href="/book" />
                </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 max-w-5xl mx-auto">
          {BROW_SERVICES.map((b, i) => (
            <div key={b.name} className={`reveal reveal-d${Math.min(i + 1, 4)} card-lift bg-white rounded-2xl p-5 border border-blush/20 flex flex-col text-center`}>
              ...
              <div className="pt-3 border-t border-blush/10 flex flex-col items-center gap-2">
                <PriceTag price={b.price} origPrice={b.origPrice} />
                <AddToCartButton variant="inline" id={b.name} name={b.name} price={b.price} duration={b.time || ''} image="https://res.cloudinary.com/dzh0mxzbg/image/upload/v1777175128/Hair_service_cover_dxozc1.png" category="Eyelash" href="/book" />
              </div>
            </div>
          ))}
        </div>
          ...
          {ADDONS.map((a, i) => (
            <div key={a.name} className={`reveal reveal-d${Math.min(i + 1, 3)} card-lift bg-white rounded-2xl p-5 border border-blush/20 text-center`}>
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <AddToCartButton variant="inline" id={a.name} name={a.name} price={a.price} duration={a.time || ''} image="https://res.cloudinary.com/dzh0mxzbg/image/upload/v1777175128/Hair_service_cover_dxozc1.png" category="Eyelash" href="/book" />
              </div>
            </div>
          ))}
        </div>
