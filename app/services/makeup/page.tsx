          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="hidden md:block" style={{ animation: 'fadeUp .9s ease .15s both' }}>
              <div className="bg-white rounded-3xl p-8 shadow-xl shadow-rose/10 border border-blush/20">
                <div className="bg-rose rounded-2xl p-6 mb-6 relative overflow-hidden">
                  <div aria-hidden className="absolute -right-8 -top-8 w-32 h-32 rounded-full opacity-20" style={{ background: '#EFCCD4' }} />
                  <p className="font-poppins text-[10px] tracking-widest uppercase text-white/60 font-semibold mb-2">Our Signature</p>
                  <p className="font-playfair text-2xl font-bold text-white mb-1">Bridal Packages</p>
                  <p className="font-poppins text-xs text-white/70">Multi-day coverage from Mehendi to Reception</p>
                </div>
                <p className="font-poppins text-xs tracking-widest uppercase text-rose font-semibold mb-4">Products Used</p>
